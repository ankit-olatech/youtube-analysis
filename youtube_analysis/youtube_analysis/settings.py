...
# settings.py
DATA_UPLOAD_MAX_MEMORY_SIZE = 10485760  # 10 MB - For PDF Report Generation

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/4.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure--k&c4$ndg0gmcl5fe_+a8k65ekwt!hlu+r)k+x$*j0v=g93m#-'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Create a 'static' folder in the project root
MEDIA_URL = '/media/'
